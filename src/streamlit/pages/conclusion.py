...
with st.expander("**Ce que nous avons appris**", expanded=True):
    ...
    - Différentes techniques de *traitement d'images* (data augmentation, détection d'objets)
...
with st.expander("**Les difficultés rencontrées**", expanded=True):
    st.markdown("""
    - Complexité du nettoyage textuel (langues multiples, bruit HTML, caractères spéciaux, problème d'encoding)
